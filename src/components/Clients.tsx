    ...
    <div className="lg:px-16 lg:py-8">
      ...
      <div className="rounded-md shadow md:mt-4 md:px-8 py-4 bg-white">
        ...
        >
          ...
          />
          <Button title="Add new Client" className=" bg-[#FCB900] text-white text-xs font-medium px-4 py-3 mt-3 md:mt-0 rounded-md md:w-1/3" OnClick={()=>{addClient()}}/>
        </form>
